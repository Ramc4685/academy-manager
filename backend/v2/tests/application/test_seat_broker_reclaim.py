...
Covers the departures design contract's C1, C2 and a lite version of C12
(the seat invariant, replayed over the fakes for a fixed sequence rather
than a full property-based generator — see the report for what is not yet
covered at full contract depth).
"""
