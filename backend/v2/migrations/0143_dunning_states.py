...
VALIDATOR: dict[str, Any] = {
    "$jsonSchema": {
        ...
        "properties": {
            ...
            "status": {"enum": ["active", "processing", "resolved", "dunned", "suppressed"]},
            "attempt_count": {"bsonType": ["int", "long"]},
            "processing_attempt_no": {"bsonType": ["int", "long", "null"]},
            "processing_worker_id": {"bsonType": OPT_STRING},
            "processing_started_at": {"bsonType": OPT_DATE},
            "lease_expires_at": {"bsonType": OPT_DATE},
            ...
            "suppression_reason": {"bsonType": OPT_STRING},
            "suppressed_at": {"bsonType": OPT_DATE},
            ...
            "autopay_disable_status": {
                "enum": [None, "pending", "succeeded", "failed", "not_required"]
            },
            "autopay_disable_error": {"bsonType": OPT_STRING},
            "autopay_disabled_at": {"bsonType": OPT_DATE},
