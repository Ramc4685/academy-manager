...
- 2026-06-08T16:53:20 main/working: Addressing PR review: paused-only enrollments must not render as next class on parent home.
## Verification
...
- 2026-06-08T15:11:01: Final branch verification after commits passed: cd frontend && node --no-warnings --test lib/parent-home.node-test.mjs (4 passed); pnpm typecheck passed; pnpm lint passed with no warnings/errors.
- 2026-06-08T16:53:20: Regression confirmed before fix: node --no-warnings --test lib/parent-home.node-test.mjs failed because paused enrollment populated nextEnrollment.
- 2026-06-08T16:53:20: Focused review fix passed: cd frontend && node --no-warnings --test lib/parent-home.node-test.mjs => 5 passed, including paused-only enrollment regression.
- 2026-06-08T16:53:45: Review fix frontend checks passed: cd frontend && pnpm typecheck; cd frontend && pnpm lint.
- 2026-06-08T16:54:35: Review fix pre-push passed: scripts/dev/pre-push-checks.sh (backend ruff/pytest, frontend unit/typecheck/lint; E2E skipped by no e2e changes rule).
## Reusable Lessons
