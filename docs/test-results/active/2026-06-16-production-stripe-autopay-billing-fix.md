...
- 2026-06-18T13:00:38 main/working: Investigating why written Charge card/frontend error-message changes are not visible in the running UI; starting with repo diff, active build/server state, and rendered browser evidence before any fixes.
- 2026-06-18T13:02:25 main/working: Root cause evidence: source and localhost:3001 dev assets include Charge card/detail handling, but saas-staging-frontend-1 on localhost:3000 serves a pre-patch production bundle whose api client ignores FastAPI detail and still uses generic Request failed.
## Verification
...
- 2026-06-18T13:05:55: Frontend rebuild attempt: scripts/dev/saas_staging.sh rebuild-ui compiled Next successfully, but Docker Desktop failed during container recreate with metadata.db input/output error. Old saas-staging-frontend-1 remains up on image sha256:3ebe6add... and localhost:3000 still serves stale page-691f856... chunk.
## Reusable Lessons
