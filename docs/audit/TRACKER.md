...
| ID | Item | Plan | Size | Depends on | Status | PR/Issue |
|---|---|---|---|---|---|---|
| MT1 | Drain the composition root (billing math → application layer) | [plans/MT1-drain-composition-root.md](plans/MT1-drain-composition-root.md) | L | — | IN PROGRESS | Phase A DONE #TBD — Phases B–E (reports read models, payouts, email adapters, import-linter contract) still TODO |
