...
| C4 | Kill boot-time academy_id closures (parent reads + coach writes) | [plans/C4-tenant-boot-closure.md](plans/C4-tenant-boot-closure.md) | M | — | IN PROGRESS | fix/C4-tenant-boot-closure |
