...
export const ADMIN_NAV: ReadonlyArray<AdminNavGroup> = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/session-economics", label: "Session economics", icon: "chart", match: startsWith("/admin/session-economics") },
...
export const SCREEN_META: Record<string, AdminScreenMeta> = {
  ...
  "/admin/session-economics": { title: "Session economics", subtitle: "Revenue, cost, and profit by session", breadcrumbs: ["Admin", "Money", "Session economics"] },
