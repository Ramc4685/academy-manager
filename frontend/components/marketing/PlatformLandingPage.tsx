...
/**
 * CourtMastr's own product landing page. Rendered by `app/page.tsx` on the
 * product hosts (lib/public-page/host.ts); a tenant host renders the
 * academy's public page instead.
 */
