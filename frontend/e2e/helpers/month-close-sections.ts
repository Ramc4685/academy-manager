...
/**
 * Month close groups its cards into collapsible sections (issue #862). Every
 * viewport starts collapsed (UI-7); a group the reader opened is remembered
 ...
 * chromium-desktop.
 *
 * It re-clicks rather than clicking once: a click that lands before React
