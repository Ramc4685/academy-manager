...
export default defineConfig({
  ...
  projects: [
    ...
    // not double (workers=2 in CI).
    {
      ...
      // family-import joins for L8b: the import preview is a five-column
      // table, scrolled sideways on a phone and whole on a desktop.
      testMatch:
        /admin-(shell|students|registrations|level-ups-lifecycle|month-close|messages|family-billing|families-index|family-record|public-page-settings|family-import)\.spec\.ts/,
    },
